...
# 日志根路径
LOG_ROOT = "/home/qiongwei/mycode/pythonenv/virtualenv/pingpongus/app/log/"
...
if  __name__ == "__main__" :
	logger = get_logger("test.log", logging.INFO)
	logger.debug("debug test") 
	logger.info("info test")
	logger.warning("warn test")
	logger.error("error test")
	# logger.info("config path: "+ app_config.log_config["save_path"])
